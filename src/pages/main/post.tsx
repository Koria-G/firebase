...
export const Post=(props:Props)=>{
  ...
  const getLikes=async()=>{
    ...
    setLikeAmount(data.docs.map((doc:any)=>({userId:doc.data().userId,likeId:doc.id})))
  }
  ...
  const hasUserLiked =likeAmount?.find((like)=>{
  ...
  return(
    <div>
      ...
      <div className='footer'>
        ...
        <p>{likeAmount&&<p>Likes:{likeAmount.length}</p>}</p>
      </div>
    </div>
  )
}